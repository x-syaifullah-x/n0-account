...
//        sharedPreferences.edit().putString(SHARED_PREFERENCES_KEY_USERNAME, "qyjt2chwgw").commit();
//        sharedPreferences.edit().putString(SHARED_PREFERENCES_KEY_PASSWORD, "nbaqldzd1d").commit();
...
//        adUnitIds.add(getString(R.string.applovin_ad_unit_id_type_banner));
...
//                String text = "Your UMN Q96 Mate has been updated. Thanks for your support";
                new RssFeedService("https://media.rss.com/your-account-is-activated-thanks-for-your-support/feed.xml").openConnection(new RssFeedResult() {
                    @Override
